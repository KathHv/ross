...
Samsung Watch
![Samsung Watch](samsung_watch.jpg)

Apple Watch
![Apple Watch](apple_watch.jpg)
...
threshold = 10
#Samsung
gpx_features_samsung_osm = bringFeatureToOSM(gpx_features_samsung_filtered, osm_features, threshold)
#saveGPXFile(gpx_features_samsung_osm, "./inst/extdata/track_samsung_watch_smoothed.gpx")
#Apple
gpx_features_apple_osm = bringFeatureToOSM(gpx_features_apple_filtered, osm_features, threshold)
...
Difficult for streets with many paths (path, footpath, street, footpath, house, footpath, streets)


As a next step the heading of the track and the corresponding OSM feature part should be recognized. The issue with jumping points on the features at junctions can be solved with that.
